...
func (h *Handler) uploadImage(c *gin.Context) {
	...
	//tempFilename := fmt.Sprintf("storage/upload/%s/%s", domains.Image, fileHeader.Filename)

	f, err := os.OpenFile("storage/"+tempFilename, os.O_CREATE|os.O_APPEND|os.O_RDWR, 0o666)
	if err != nil {
